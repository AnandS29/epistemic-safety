...
risk_levels = np.round(np.linspace(0,5,51),2)
states = []
...
game = {
    ...
    "transition":(lambda state, uH, uR, dr : transition(state, uH, uR, dr, check=False, initial=initial)), 
    "reward":reward,
    "gamma":gamma, "T":T
}

fname = "general_example"
